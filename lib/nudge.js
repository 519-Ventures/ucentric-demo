...
module.exports = function(settings) {
  ...
  const youtubeId = settings.youtubeId || 'kQ4DmRHBYkE';
  const memeUrl = settings.memeUrl || 'https://media.makeameme.org/created/subitup-is-filling.jpg';
  const heroUrl = settings.heroUrl || 'https://img.yasteq.com/2/safe_image.php?d=AQCjmEr9DNN6C5nu&url=http%3A%2F%2Fcampusrecmag.com%2Fwp-content%2Fuploads%2F2016%2F11%2FAds-Campus-Rec_Banner.png&_nc_hash=AQCKZphJrA5-79zu';
...
<p>Notice the "reference" field that gets sent in. You can provide an id to tie this message back to your system. This enables you to creative Nudges that interact with you app.</p>
  ...
  function postNudge(nudge, callback) {
    ...
    var req = https.request(options, function (res) {
      ...
      res.on("end", function () {
        ...
        console.log(`Nduge Created. Response: ${body.toString()}`);
        callback();
      });
    });
